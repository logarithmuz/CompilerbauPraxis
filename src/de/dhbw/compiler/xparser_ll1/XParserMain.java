...
public class XParserMain {
	...
	public static void main(String[] args) throws Exception {
		...
		TokenBuffer tokenReader = new TokenBuffer(scanner);
		...
		if (out != null) {
			...
			System.out.println("Anzahl Token:      " + tokenReader.getTokenCount());
			System.out.println("Anzahl Vergleiche: " + xParser.getComparecount());
